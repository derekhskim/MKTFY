...
class ImageCarouselCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        layout?.itemSize = CGSize(width: bounds.width, height: 375)
...
extension ImageCarouselCollectionViewCell: UICollectionViewDataSource {
...
extension ImageCarouselCollectionViewCell: UICollectionViewDelegate {
